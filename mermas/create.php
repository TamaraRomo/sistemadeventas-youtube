...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Registro de una nueva merma</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                   ...
                   <div class="row">
                       <div class="col-md-12">
                           <div class="card card-outline card-primary">
                               <div class="card-header">
                                   <h3 class="card-title">Detalle de la merma</h3>
                                   <div class="card-tools">
                                   ...
                                   <div class="row">
                                       <div class="col-md-12">
                                           <div class="form-group">
                                               ...
                                               ?>
                                               <label for="">Número de la merma</label>
                                       ...
                                       <div class="col-md-12">
                                           <div class="form-group">
                                               <label for="">Fecha de la merma</label>
                                       ...
                                       <div class="col-md-12">
                                           <div class="form-group">
                                               <label for="">Cantidad de la merma</label>
                                   ...
                                   <script>
                                       $('#btn_guardar_compra').click(function () {
                                           ...
                                           if(id_producto == ""){
                                               ...
                                               var url = "../app/controllers/mermas/create.php";
