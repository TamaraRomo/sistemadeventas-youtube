...
$sentencia = $pdo->prepare("DELETE FROM tb_mermas WHERE id_compra=:id_compra");
...
if($sentencia->execute()){
    ...
    $_SESSION['mensaje'] = "Se eliminó la merma de manera correcta";
    $_SESSION['icono'] = "success";
    // header('Location: '.$URL.'/categorias/');
    ?>
    <script>
        location.href = "<?php echo $URL;?>/mermas";
    </script>
    <?php
}else{
