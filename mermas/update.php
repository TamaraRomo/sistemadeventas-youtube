...
include ('../app/controllers/mermas/cargar_merma.php');
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Actualización de la merma</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                            ...
                            <div class="card card-outline card-primary">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="">Número de merma</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="">Comprobante de la merma</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="">Precio que se compro</label>
                                    ...
                                    <script>
                                        $('#btn_actualizar_compra').click(function () {
                                            ...
                                            if(id_producto == ""){
                                                ...
                                                var url = "../app/controllers/mermas/update.php";
